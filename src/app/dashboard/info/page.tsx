...
export default function DashboardInfoHubPage() {
  ...
  const knowledgeBase: KnowledgeItem[] = useMemo(() => [
    ...
    // --- TAMBAHAN MATERI REKOMENDASI (SESUAI REQUEST) ---
    
    // PROVIDER SUPPLEMENT
    {
      id: 'kb-prov-1',
      category: 'CARA_KERJA',
      categoryLabel: 'SOP Provider',
      categoryBadgeColor: 'bg-blue-100 text-blue-900 border-blue-300',
      roleTarget: 'PROVIDER',
      title: 'Panduan Praktis SOP Restoran & Bakery',
      subtitle: 'Standar Operasional Penanganan Surplus Makanan',
      content: 'Setiap restoran dan bakery diwajibkan untuk mengemas makanan sebelum jam operasional berakhir dan memastikan kualitas sensorik (SOP Restoran) masih dalam kondisi prima. Label jam kedaluwarsa wajib terpasang.',
      tags: ['sop restoran', 'panduan praktis', 'provider', 'bakery'],
    },
    {
      id: 'kb-prov-2',
      category: 'BPOM',
      ...
      categoryBadgeColor: 'bg-amber-100 text-amber-900 border-amber-300',
      roleTarget: 'PROVIDER',
      title: 'Penerapan Checklist 8 BPOM Sebelum Serah Terima',
      subtitle: 'Protokol Wajib Keamanan Pangan Replate',
      content: 'Pastikan Anda telah mengisi Checklist 8 BPOM (Batas Waktu, Suhu, Kemasan, Sensorik, Bebas Bau, Alergen, Sanitasi Dapur, Batas Konsumsi) di aplikasi sebelum menekan tombol Siap Diambil.',
      tags: ['checklist 8 bpom', 'bpom', 'keamanan', 'higienitas'],
    },
    {
      id: 'kb-prov-3',
      category: 'CARA_KERJA',
      categoryLabel: 'Laporan Provider',
      categoryBadgeColor: 'bg-emerald-100 text-emerald-900 border-emerald-300',
      roleTarget: 'PROVIDER',
      title: 'Validasi & Unduh Sertifikat CSR Berkelanjutan',
      subtitle: 'Bukti Kontribusi Laporan Emisi & Sosial',
      content: 'Sertifikat CSR otomatis ter-generate di Dashboard setelah Anda menyelesaikan minimal 5 transaksi donasi/rescue. Sertifikat ini bisa dilampirkan untuk audit ESG dan pemotongan pajak.',
      tags: ['sertifikat csr', 'esg', 'pajak', 'laporan'],
    },
    ...
    // BENEFICIARY SUPPLEMENT
    {
      id: 'kb-ben-1',
      category: 'CARA_KERJA',
      categoryLabel: 'SOP Beneficiary',
      categoryBadgeColor: 'bg-emerald-100 text-emerald-900 border-emerald-300',
      roleTarget: 'BENEFICIARY',
      title: 'Tata Cara Pengajuan Permintaan Pangan Panti',
      subtitle: 'Memastikan Pasokan Makanan Tepat Waktu',
      content: 'Yayasan dapat mengajukan Permintaan Pangan Panti melalui menu Dashboard. Tentukan jumlah porsi anak asuh, kebutuhan khusus, dan batas jam makan malam agar sistem dapat mencarikan restoran terdekat.',
      tags: ['permintaan pangan panti', 'yayasan', 'panti asuhan', 'kebutuhan'],
    },
    {
      id: 'kb-ben-2',
      category: 'KALKULATOR',
      ...
      roleTarget: 'BENEFICIARY',
      title: 'Alokasi Cerdas Menggunakan Smart Matching GPS',
      subtitle: 'Radius Maksimal & Penugasan Kurir',
      content: 'Fitur Smart Matching GPS secara otomatis mempertemukan permintaan panti asuhan dengan pasokan surplus restoran terdekat (radius optimal < 10 km) untuk menjamin makanan tiba dalam kondisi hangat.',
      tags: ['smart matching gps', 'alokasi', 'ai', 'radius'],
    },
    {
      id: 'kb-ben-3',
      category: 'KALKULATOR',
      categoryLabel: 'Kalkulator Gizi',
      categoryBadgeColor: 'bg-cyan-100 text-cyan-900 border-cyan-300',
      roleTarget: 'BENEFICIARY',
      title: 'Perhitungan AKG Nutrisi (Angka Kecukupan Gizi)',
      subtitle: 'Pemenuhan Kalori Anak Asuh',
      content: 'Replate menghitung estimasi AKG Nutrisi (rata-rata 336 kkal per porsi). Bantuan yang disalurkan bertujuan untuk memenuhi defisit kalori harian bagi masyarakat rentan.',
      tags: ['akg nutrisi', 'kalori', 'gizi', 'kesehatan'],
    },
    {
      id: 'kb-ben-4',
      category: 'BPOM',
      ...
      categoryBadgeColor: 'bg-amber-100 text-amber-900 border-amber-300',
      roleTarget: 'BENEFICIARY',
      title: 'Penerimaan Makanan: Cek BPOM Suhu & Kemasan',
      subtitle: 'Hak Tolak Penerima Jika Kondisi Buruk',
      content: 'Saat kurir tiba, pengurus yayasan wajib mengecek BPOM Suhu (apakah makanan masih hangat/dingin) dan kelayakan kemasan. Anda berhak menolak makanan jika sudah basi atau kemasan rusak.',
      tags: ['bpom suhu', 'penerimaan', 'inspeksi panti'],
    },
    ...
    // VOLUNTEER SUPPLEMENT
    {
      id: 'kb-vol-1',
      category: 'CARA_KERJA',
      categoryLabel: 'SOP Volunteer',
      categoryBadgeColor: 'bg-purple-100 text-purple-900 border-purple-300',
      roleTarget: 'VOLUNTEER',
      title: 'Mengakses Surat Jalan WA (WhatsApp)',
      subtitle: 'Tanpa Perlu Instal Aplikasi Tambahan',
      content: 'Kurir Relawan akan menerima notifikasi tugas beserta link Surat Jalan WA. Link ini berisi rincian pesanan, alamat jemput, alamat antar, dan tiket QR secara real-time tanpa harus login ke dashboard.',
      tags: ['surat jalan wa', 'whatsapp', 'notifikasi', 'kurir'],
    },
    {
      id: 'kb-vol-2',
      category: 'CARA_KERJA',
      ...
      categoryBadgeColor: 'bg-purple-100 text-purple-900 border-purple-300',
      roleTarget: 'VOLUNTEER',
      title: 'Protokol Pemindaian QR Serah Terima Toko',
      subtitle: 'Bukti Serah Terima yang Sah',
      content: 'Saat tiba di restoran, tunjukkan HP Anda untuk discan oleh kasir, atau gunakan fitur Kamera Scanner untuk memindai QR Serah Terima Toko. Status akan otomatis berubah menjadi "Dalam Perjalanan".',
      tags: ['qr serah terima toko', 'scan qr', 'pengambilan'],
    },
    {
      id: 'kb-vol-3',
      category: 'BPOM',
      ...
      categoryBadgeColor: 'bg-amber-100 text-amber-900 border-amber-300',
      roleTarget: 'VOLUNTEER',
      title: 'Kewajiban Inspeksi Suhu Kurir & Segel Wadah',
      subtitle: 'Standar Logistik Pangan Relawan',
      content: 'Sebelum membawa pergi makanan, lakukan Inspeksi Suhu Kurir secara sentuhan fisik ke wadah, pastikan segel utuh, dan makanan dimasukkan ke dalam Tas Termal (Cooler Box) untuk menjaga kualitas selama di jalan.',
      tags: ['inspeksi suhu kurir', 'tas termal', 'segel', 'logistik'],
    },
    {
      id: 'kb-vol-4',
      category: 'CARA_KERJA',
      ...
      categoryBadgeColor: 'bg-purple-100 text-purple-900 border-purple-300',
      roleTarget: 'VOLUNTEER',
      title: 'Pemakaian Manifest Digital untuk Rute Ganda',
      subtitle: 'Efisiensi Pengantaran Sekaligus',
      content: 'Jika Anda membawa lebih dari satu pesanan, Manifest Digital akan mengurutkan prioritas pengantaran berdasarkan waktu kedaluwarsa terdekat untuk menghindari pembusukan di jalan.',
      tags: ['manifest digital', 'rute ganda', 'efisiensi'],
    },
    {
      id: 'kb-vol-5',
      category: 'CARA_KERJA',
      ...
      categoryBadgeColor: 'bg-blue-100 text-blue-900 border-blue-300',
      roleTarget: 'VOLUNTEER',
      title: 'Navigasi Pintar via Rute Google Maps',
      subtitle: 'Tombol Pintas Arah Perjalanan',
      content: 'Gunakan tombol Rute Google Maps yang ada di dalam lembar kerja Anda untuk mendapatkan panduan arah GPS turn-by-turn langsung menuju titik lokasi penerima tanpa harus mengetik manual alamatnya.',
      tags: ['rute google maps', 'navigasi', 'gps', 'arah'],
    },
    ...
    // CONSUMER SUPPLEMENT
    {
      id: 'kb-cons-1',
      category: 'CARA_KERJA',
      categoryLabel: 'SOP Consumer',
      categoryBadgeColor: 'bg-cyan-100 text-cyan-900 border-cyan-300',
      roleTarget: 'CONSUMER',
      title: 'Berburu Makanan di Menu Rescue Sale Diskon',
      subtitle: 'Makan Enak, Harga Mahasiswa',
      content: 'Program Rescue Sale Diskon menawarkan potongan harga dari 50% hingga 70% untuk menu-menu layak konsumsi yang belum terjual di restoran. Bantu kurangi sampah dan hemat uang saku Anda!',
      tags: ['rescue sale diskon', 'diskon', 'mahasiswa', 'hemat'],
    },
    {
      id: 'kb-cons-2',
      category: 'CARA_KERJA',
      ...
      categoryBadgeColor: 'bg-cyan-100 text-cyan-900 border-cyan-300',
      roleTarget: 'CONSUMER',
      title: 'Proses Check-out & Bayar QRIS Tanpa Admin',
      subtitle: 'Metode Pembayaran Digital Instan',
      content: 'Setelah memasukkan menu ke keranjang, selesaikan pesanan dengan klik Bayar QRIS. Pindai kode QR menggunakan aplikasi e-Wallet atau m-Banking Anda. Transaksi diproses seketika tanpa biaya admin.',
      tags: ['bayar qris', 'checkout', 'pembayaran', 'e-wallet'],
    },
    {
      id: 'kb-cons-3',
      category: 'CARA_KERJA',
      ...
      categoryBadgeColor: 'bg-cyan-100 text-cyan-900 border-cyan-300',
      roleTarget: 'CONSUMER',
      title: 'Validasi Jemput dengan Ambil Toko QR Resi',
      subtitle: 'Serah Terima di Kasir Outlet',
      content: 'Pilih opsi Self-Pickup, datang ke outlet sebelum waktu habis, dan tunjukkan tiket Ambil Toko QR Resi di HP Anda kepada pelayan restoran untuk mengambil pesanan Anda dengan cepat.',
      tags: ['ambil toko qr resi', 'self pickup', 'kasir'],
    },
    {
      id: 'kb-cons-4',
      category: 'CARA_KERJA',
      ...
      categoryBadgeColor: 'bg-cyan-100 text-cyan-900 border-cyan-300',
      roleTarget: 'CONSUMER',
      title: 'Pentingnya Memberikan Ulasan Rating',
      subtitle: 'Membangun Reputasi Restoran',
      content: 'Selesai menyantap, jangan lupa berikan Ulasan Rating bintang 5 dan komentar positif Anda. Ulasan Anda memotivasi mitra restoran untuk terus ikut serta dalam kampanye penyelamatan pangan.',
      tags: ['ulasan rating', 'review', 'reputasi', 'bintang'],
    },
    {
      id: 'kb-cons-5',
      category: 'BPOM',
      ...
      categoryBadgeColor: 'bg-amber-100 text-amber-900 border-amber-300',
      roleTarget: 'CONSUMER',
      title: 'Jaminan BPOM Higienitas untuk Konsumen',
      subtitle: 'Aman dan Bernutrisi',
      content: 'Jangan khawatir, semua menu di aplikasi ini telah melewati uji BPOM Higienitas secara mandiri oleh mitra. Makanan yang Anda beli dijamin bukan makanan sisa gigitan, melainkan surplus yang belum disentuh pelanggan.',
      tags: ['bpom higienitas', 'aman', 'kualitas', 'surplus'],
    },
  ], []);
