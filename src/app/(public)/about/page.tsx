              ...
              {teamMembers.map((member, idx) => (
                <div key={idx} className="border border-slate-200 p-6 text-center space-y-4 hover:shadow-md transition-all bg-white rounded-3xl">
                  ...
                  <div className="flex items-center justify-center gap-3 pt-2">
                    <a href="https://www.instagram.com/daffa_fab?igsi=Y3QzeHhubzZuZXVk" target="_blank" rel="noopener noreferrer" className="p-2 bg-pink-50 hover:bg-pink-100 text-pink-600 rounded-full transition-colors cursor-pointer" title="Instagram">
                    ...
                    <a href="https://www.linkedin.com/in/fabio-daffa-a8205b42b?utm_source=share_via&utm_content=profile&utm_medium=member_android" target="_blank" rel="noopener noreferrer" className="p-2 bg-blue-50 hover:bg-blue-100 text-blue-600 rounded-full transition-colors cursor-pointer" title="LinkedIn">
