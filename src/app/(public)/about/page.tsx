                ...
                <div key={idx} className="border border-slate-200 p-6 text-center space-y-4 hover:shadow-md transition-all bg-white rounded-3xl">
                  ...
                  <div className="flex items-center justify-center gap-3 pt-2">
                    {(member as any).instagram && (
                      <a href={(member as any).instagram} target="_blank" rel="noopener noreferrer" className="p-2 bg-pink-50 hover:bg-pink-100 text-pink-600 rounded-full transition-colors cursor-pointer" title="Instagram">
                    ...
                    {(member as any).linkedin && (
                      <a href={(member as any).linkedin} target="_blank" rel="noopener noreferrer" className="p-2 bg-blue-50 hover:bg-blue-100 text-blue-600 rounded-full transition-colors cursor-pointer" title="LinkedIn">
