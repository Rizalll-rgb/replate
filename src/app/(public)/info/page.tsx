...
export default function PublicInfoHubPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F8F9FA]">
      ...
      <main className="flex-1 py-12 max-w-5xl w-full mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        {/* Header Hero */}
        <div className="text-center space-y-3 max-w-3xl mx-auto">
          ...
          <p className="text-xs sm:text-sm text-slate-600 leading-relaxed font-medium">
            Temukan seluruh panduan operasional per peran, protokol higienitas pangan BPOM RI, simulasi kalkulator jejak karbon IPCC, dan FAQ terpadu.
          </p>
        </div>
