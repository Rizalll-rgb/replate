...
export default function PublicInfoHubPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F8F9FA] text-slate-900 font-sans">
      ...
      <main className="flex-1 max-w-6xl w-full mx-auto px-4 sm:px-6 py-10 sm:py-14 space-y-8">
        {/* Hero Section */}
        <div className="text-center space-y-3 max-w-3xl mx-auto">
          ...
          <p className="text-sm sm:text-base text-slate-600 font-medium leading-relaxed">
            Kajian Komprehensif Food Loss & Waste (FLW) Indonesia, Protokol Higienitas BPOM RI, Kalkulator Emisi Hilir, dan FAQ Ekosistem.
          </p>
        </div>

        {/* Global Search Bar & Quick Filter Section */}
        <div className="bg-white p-5 sm:p-6 rounded-3xl border border-slate-200 shadow-sm space-y-4">
          <div className="relative">
            ...
            <input
              ...
              placeholder="Cari regulasi BPOM, data Bappenas, SOP role, emisi CO2, atau FAQ operasional..."
              className="w-full pl-12 pr-10 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl text-xs sm:text-sm font-semibold text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#1B3A5C] focus:bg-white transition-all shadow-inner"
            />
            {searchQuery && (
              <button
                type="button"
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 bg-[#1B3A5C] text-white p-4 sm:p-5 rounded-2xl border border-[#2C5A8F] shadow-sm">
              <div className="space-y-0.5">
                <span className="text-[10px] font-black text-[#D4A843] uppercase tracking-wider block">
                  HASIL PENCARIAN PUSAT INFORMASI
                </span>
            ...
            {searchResults.length === 0 ? (
              <div className="bg-white p-10 rounded-3xl border border-slate-200 text-center space-y-3">
                ...
                <p className="text-xs text-slate-500 max-w-md mx-auto">
                  Tidak ditemukan hasil untuk kata kunci &quot;{searchQuery}&quot;. Silakan coba kata kunci lain seperti <strong>BPOM</strong>, <strong>Bappenas</strong>, <strong>Emisi</strong>, atau <strong>SOP Role</strong>.
                </p>
                <Button
                  variant="primary"
                  size="sm"
        ...
        <div id="info-content-container" className="flex flex-wrap items-center gap-2 p-2 bg-slate-200/80 rounded-2xl scroll-mt-24">
          <button
            ...
            className={`flex-1 py-3 px-3 rounded-xl font-black text-xs transition-all cursor-pointer whitespace-nowrap text-center ${
        ...
        {/* TAB 1: LATAR BELAKANG & URGENSI NASIONAL */}
        {activeTab === 'LATAR_BELAKANG' && (
        ...
        {/* TAB 2: KALKULATOR DAMPAK BAPPENAS */}
        {activeTab === 'KALKULATOR' && (
