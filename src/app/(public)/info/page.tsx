...
export default function PublicInfoHubPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F8F9FA] text-slate-900 font-sans">
      ...
      <main className="flex-1 max-w-6xl w-full mx-auto px-4 sm:px-6 py-10 sm:py-14 space-y-10">
        {/* Hero Section */}
        ...
        <div className="flex flex-wrap items-center gap-2 p-2 bg-slate-200/80 rounded-2xl">
          <button
            type="button"
