...
export const Sidebar: React.FC<SidebarProps> = ({ role = 'PROVIDER' }) => {
  ...
  const consumerLinks = [
    ...
    {
      href: '/dashboard/consumer/history',
      label: 'Riwayat Klaim',
      icon: (
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const partnerLinks = [
    ...
    {
      href: '/dashboard/rescue-partner/distribution',
      label: 'Penyaluran',
      icon: (
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      href: '/dashboard/rescue-partner/impact',
  ...
  // Filter out any commonLinks that have duplicate labels or duplicate hrefs
  const allLinks = [
    ...links,
      ...
      >
        ...
        <div className="mt-8 border-t border-[#2C5A8F]/40 pt-4">
          <button
            ...
            className="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-xs font-bold text-red-400 hover:bg-[#142C47] hover:text-red-300 w-full transition-colors"
          >
